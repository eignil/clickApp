...
class StatisticsChartsView extends StatelessWidget {
  final String type;
  StatisticsChartsView({required this.type});

  late List<List<String>> record;
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      Expanded(
                        child: charts.PieChart(_getData(type),
                            animate: true,
  ...
  List<charts.Series<TaskStatisticsModel, String>> _getData(String type) {
    ...
    return [
      new charts.Series<TaskStatisticsModel, String>(
        ...
        data: data,
        labelAccessorFn: (TaskStatisticsModel model, _) =>
            '${model.moduleName}: ${model.percentage}%',
      )
    ];
  }
